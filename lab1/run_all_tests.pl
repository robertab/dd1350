...
run_all_tests(ProgramToTest) :-
    ...
    all_valid_ok(['test.txt', 'valid01.txt', 'valid09.txt', 'valid12.txt',
		  'valid13.txt', 'valid14.txt', 'valid15.txt']),
    all_invalid_ok(['invalid02.txt', 'invalid06.txt', 'invalid12.txt',
    		    'invalid13.txt', 'invalid14.txt', 'invalid15.txt',
		    'invalid16.txt', 'invalid17.txt', 'invalid18.txt',
		    'invalid21.txt', 'invalid23.txt']),

    %% # all_valid_ok(['test.txt', 'valid01.txt', 'valid02.txt', 'valid03.txt',
